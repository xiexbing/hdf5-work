...
void read_h5_data(int rank, hid_t loc, hid_t filespace, hid_t memspace)
{
    ...
    dset_ids[0] = H5Dopen2(loc, "x", dapl);
    dset_ids[1] = H5Dopen2(loc, "y", dapl);
    dset_ids[2] = H5Dopen2(loc, "z", dapl);
    dset_ids[3] = H5Dopen2(loc, "id1", dapl);
    dset_ids[4] = H5Dopen2(loc, "id2", dapl);
    dset_ids[5] = H5Dopen2(loc, "px", dapl);
    dset_ids[6] = H5Dopen2(loc, "py", dapl);
    dset_ids[7] = H5Dopen2(loc, "pz", dapl);

    ierr = H5Dread(dset_ids[0], H5T_NATIVE_FLOAT, memspace, filespace, H5P_DEFAULT, x);
    ierr = H5Dread(dset_ids[1], H5T_NATIVE_FLOAT, memspace, filespace, H5P_DEFAULT, y);
    ierr = H5Dread(dset_ids[2], H5T_NATIVE_FLOAT, memspace, filespace, H5P_DEFAULT, z);
    ierr = H5Dread(dset_ids[3], H5T_NATIVE_INT, memspace, filespace, H5P_DEFAULT, id1);
    ierr = H5Dread(dset_ids[4], H5T_NATIVE_INT, memspace, filespace, H5P_DEFAULT, id2);
    ierr = H5Dread(dset_ids[5], H5T_NATIVE_FLOAT, memspace, filespace, H5P_DEFAULT, px);
    ierr = H5Dread(dset_ids[6], H5T_NATIVE_FLOAT, memspace, filespace, H5P_DEFAULT, py);
    ierr = H5Dread(dset_ids[7], H5T_NATIVE_FLOAT, memspace, filespace, H5P_DEFAULT, pz);
